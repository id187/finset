...
const statusLabels: Record<string, string> = { comparison_ready: '이전 월적금 검수 통과', review_required: '조건·경로 검수 필요', browse_only: '정보 조회', source_issue: '수집 오류' }
const kinds: Record<string, string> = { saving: '적금', deposit: '예금', demand_deposit: '입출금' }
const reasons: Record<string, string> = {
  not_digital: '앱·웹 가입 경로 미연결', bonus_clause_review: '우대 원문 추가 해석 필요', not_monthly_saving: '이전 월 적금 검수 범위 밖',
